...
public class LoaderActor extends AbstractBehavior<RootActor.Command> {
    ...
    public static Behavior<RootActor.Command> create(DocumentsCounter documentsCounter, TerminationFlag terminationFlag, ActorRef<RootActor.Command> parentActorRef) {
        return Behaviors.setup(context -> new LoaderActor(context, documentsCounter, terminationFlag, parentActorRef));
    }

    private LoaderActor(ActorContext<RootActor.Command> context, DocumentsCounter documentsCounter, TerminationFlag terminationFlag, ActorRef<RootActor.Command> parentActorRef) throws IOException {
        super(context);
